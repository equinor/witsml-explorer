...
const TubularComponentContextMenu = (props: TubularComponentContextMenuProps): React.ReactElement => {
  const { checkedTubularComponents, dispatchOperation, selectedTubular, selectedServer } = props;

  const onClickCopy = async () => {
    const tubularComponentsReference = createTubularComponentsReference(checkedTubularComponents, selectedTubular, selectedServer.url);
  ...
  const onConfirmDelete = async () => {
    ...
    const { wellUid, wellboreUid, uid } = selectedTubular;
