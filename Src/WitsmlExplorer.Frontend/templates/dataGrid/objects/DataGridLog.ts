    ...
    },
    {
      ...
      properties: [
        ...
        },
        {
          ...
          required: false,
          baseType: "double",
          witsmlType: "ratioGenericMeasure",
          documentation:
        ...
        },
        {
          ...
          properties: [
            ...
            },
            {
              ...
              required: false,
              baseType: "double",
              witsmlType: "perLengthMeasure",
              documentation:
                "Data density of sample in samples per length unit.",
              properties: dataGridUomProperties("perLengthUom")
            },
            {
              name: "traceState",
              required: false,
              baseType: "string",
              witsmlType: "logTraceState",
              maxLength: 50,
