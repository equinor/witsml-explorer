...
export const LOGS_CURVE_INFO_LIST_VIEW_ROUTE_PATH = `${LOG_OBJECT_VIEW_ROUTE_PATH}/${LOGS_CURVE_VALUES_PATH}`;
...
export const LOGS_CURVE_INFO_LIST_VIEW_NAVIGATION_PATH = `/${SERVER_ROUTE_PATH}/${LOGS_CURVE_INFO_LIST_VIEW_ROUTE_PATH}`;
