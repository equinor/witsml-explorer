...
export const COMPONENT_GROUP_PARAM = ":componentGroup";
export const COMPONENT_UID_PARAM = ":componentUid";
export const LOG_TYPE_PARAM = ":logType";
export const FILTER_TYPE_PARAM = ":filterType";
export const DATA_SOURCE_CONFIGURATION_UID_PARAM =
...
export const COMPONENT_VIEW_ROUTE_PATH = `${OBJECT_VIEW_ROUTE_PATH}/${COMPONENTS_PATH}/${COMPONENT_GROUP_PARAM}/${COMPONENT_UID_PARAM}`;
...
export const RELEASE_NOTES_ROUTE_PATH = `${RELEASE_NOTES_PATH}`;
export const QUERY_VIEW_ROUTE_PATH = `${QUERY_PATH}`;
export const SEARCH_VIEW_ROUTE_PATH = `${SEARCH_PATH}/${FILTER_TYPE_PARAM}`;
export const DATA_SOURCE_CONFIGURATION_VIEW_ROUTE_PATH = `${COMPONENT_VIEW_ROUTE_PATH}/${DATA_SOURCE_CONFIGURATION_UID_PARAM}`;
...
export const COMPONENT_VIEW_NAVIGATION_PATH = `/${SERVER_ROUTE_PATH}/${COMPONENT_VIEW_ROUTE_PATH}`;
...
export const MULTIPLE_LOG_CURVE_SELECTION_NAVIGATION_PATH = `/${SERVER_ROUTE_PATH}/${MULTIPLE_LOG_CURVE_SELECTION_PATH}/${LOG_TYPE_PARAM}`;
export const DATA_SOURCE_CONFIGURATION_VIEW_NAVIGATION_PATH = `/${SERVER_ROUTE_PATH}/${DATA_SOURCE_CONFIGURATION_VIEW_ROUTE_PATH}`;
export const RELEASE_NOTES_NAVIGATION_PATH = `/${SERVER_ROUTE_PATH}/${RELEASE_NOTES_ROUTE_PATH}`;
