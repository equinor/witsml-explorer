...
export const LOGS_CURVE_INFO_LIST_VIEW_ROUTE_PATH = `${LOG_TYPES_VIEW_ROUTE_PATH}/${LOG_TYPE_PARAM}/${MULTIPLE_LOGS}`;
...
export const MULTI_LOGS_CURVE_INFO_LIST_VIEW_NAVIGATION_PATH = `/${SERVER_ROUTE_PATH}/${LOGS_CURVE_INFO_LIST_VIEW_ROUTE_PATH}`;
