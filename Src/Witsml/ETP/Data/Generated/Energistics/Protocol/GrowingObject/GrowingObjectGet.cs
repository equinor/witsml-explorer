...
namespace Energistics.Protocol.GrowingObject
{
	...
	public partial class GrowingObjectGet : global::Avro.Specific.ISpecificRecord
	{
		public static global::Avro.Schema _SCHEMA = global::Avro.Schema.Parse(@"{""type"":""record"",""name"":""GrowingObjectGet"",""namespace"":""Energistics.Protocol.GrowingObject"",""fields"":[{""name"":""uri"",""type"":""string""},{""name"":""uid"",""type"":""string""}],""messageType"":""3"",""protocol"":""6"",""senderRole"":""customer"",""protocolRoles"":""store,customer"",""fullName"":""Energistics.Protocol.GrowingObject.GrowingObjectGet"",""depends"":[]}");
		private string _uri;
		private string _uid;
