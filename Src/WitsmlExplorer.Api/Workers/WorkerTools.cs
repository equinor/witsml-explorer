...
namespace WitsmlExplorer.Api.Workers
{
    public static class WorkerTools
    {
        ...
        public static void LogSuccess(string jobType, string sourceWell, string sourceWellbore, string parentObjectType, string sourceParent, string objectType, IEnumerable<string> sourceObjects, string targetWell, string targetWellbore)
        {
            Log.Information(
                    "{JobType} - Job successful. Source: UidWell: {SourceWell}, UidWellbore: {SourceWellbore}, {parentObjectType}Uid: {sourceParent}, {objectType}Uids: {sourceObjects}. " +
                    "Target: UidWell: {TargetWell}, UidWellbore: {TargetWellbore}", jobType, sourceWell, sourceWellbore, parentObjectType, sourceParent, objectType, string.Join(",", sourceObjects), sourceObjects, targetWell, targetWellbore);
        }
        ...
        public static void LogError(string jobType, string sourceWell, string sourceWellbore, string parentObjectType, string sourceParent, string objectType, IEnumerable<string> sourceObjects, string targetWell, string targetWellbore)
        {
            Log.Error(
                    "{JobType} - Job failed. Source: UidWell: {SourceWell}, UidWellbore: {SourceWellbore}, {parentObjectType}Uid: {sourceParent}, {objectType}Uids: {sourceObjects}. " +
                    "Target: UidWell: {TargetWell}, UidWellbore: {TargetWellbore}", jobType, sourceWell, sourceWellbore, parentObjectType, sourceParent, objectType, string.Join(",", sourceObjects), sourceObjects, targetWell, targetWellbore);
        }
    }
}
