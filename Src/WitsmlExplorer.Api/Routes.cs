...
namespace WitsmlExplorer.Api
{
    public static class Routes
    {
        public static void ConfigureApi(this WebApplication app, IConfiguration configuration)
        {
            ...
            app.MapPatch("/wells/{wellUid}/wellbores/{wellboreUid}/logCurvePriority", LogCurvePriorityHandler.UpdatePrioritizedCurves, useOAuth2);
            app.MapPatch("/wells/{wellUid}/wellbores/{wellboreUid}/logCurvePriority/delete", LogCurvePriorityHandler.DeletePrioritizedCurves, useOAuth2);
