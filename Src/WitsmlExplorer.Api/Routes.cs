...
namespace WitsmlExplorer.Api
{
    public static class Routes
    {
        public static void ConfigureApi(this WebApplication app, IConfiguration configuration)
        {
            ...
            app.MapPost("/wells/{wellUid}/wellbores/{wellboreUid}/multilogdata", LogHandler.GetMultiLogData, useOAuth2);
            ...
            app.MapPost(routes[EntityType.Log] + "/" + ComponentType.Mnemonic.ToPluralLowercase(), LogHandler.GetMultiLogCurveInfo, useOAuth2);
