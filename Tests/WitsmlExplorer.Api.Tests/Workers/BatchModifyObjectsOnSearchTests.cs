...
{
    public class BatchModifyObjectsOnSearchTests
    {
        private readonly Mock<IWitsmlClient> _witsmlClient;
        private readonly BatchModifyObjectsOnSearchWorker _worker;
        ...
        public BatchModifyObjectsOnSearchTests()
        {
            ...
            ILogger<BatchModifyObjectsOnSearchJob> logger = loggerFactory.CreateLogger<BatchModifyObjectsOnSearchJob>();
            _worker = new BatchModifyObjectsOnSearchWorker(logger, witsmlClientProvider.Object);
        }

        [Fact]
        public async Task ModifyLogObject_KeepsSameUids()
        {
            BatchModifyObjectsOnSearchJob job = CreateJobTemplate();
        ...
        public async Task RenameLogObject_ValidName_UpdatesName()
        {
            ...
            BatchModifyObjectsOnSearchJob job = CreateJobTemplate("name", expectedNewName);
        ...
        {
            BatchModifyObjectsOnSearchJob job = CreateJobTemplate("name", string.Empty);
        ...
        private static BatchModifyObjectsOnSearchJob CreateJobTemplate(string property = null, string propertyValue = null)
        {
            var job = new BatchModifyObjectsOnSearchJob
            {
